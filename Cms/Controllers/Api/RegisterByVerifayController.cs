...
{
    public class RegisterByVerifayController : ApiController
    {
        ...
        public ApiResult Post(Account account, bool remember = false, string confirm = "", string captcha = "", string bothEmailMobile = "false")
        {
            ...
            ApiResult result = ApiAccount.Post_DoRegister2(_context, account, true, confirm, bothEmailMobile, iswebsiteSetting);
